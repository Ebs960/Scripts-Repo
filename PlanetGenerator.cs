...
public class PlanetGenerator : MonoBehaviour, IHexasphereGenerator
{
    ...
    // Runtime-generated textures removed in prefab-based system
    ...
    public System.Collections.IEnumerator GenerateSurface()
    {
        ...
        // GPU river carving removed in prefab-based system

        // Texture syncing removed in prefab-based system
    ...
    private GameObject GetPrefabForTile(HexTileData tile)
    {
        if (biomePrefabLookup.TryGetValue(tile.biome, out var prefab))
            return prefab;
        Debug.LogWarning($"No prefab mapped for biome {tile.biome}");
        return null;
    }
